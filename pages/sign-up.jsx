  ...
  return (
    <>
      <Flex direction="column" justify="center" align="center" minH="100vh">
        <Container>
          <Text fontSize="2xl" textAlign="center" fontWeight="semibold" marginBottom="1" className="fst-italic">Sign Up</Text>
          <Text fontSize="xm" textAlign="center" marginBottom="7" className="fw-semibold" color="brand.100">Create an account to continue</Text>
